...
function Cart() {
  ...
  const products = Object.keys(items).map((item) => items[item].items[0]);
            ...
            <div className="cart">
              ...
              <div className="content__items">
                {products.map((item, index) => (
                  <CartItem
                    ...
                    handleRemoveProduct={removeItem}
                    handleCountPlus={countPlus}
                    handleCountMinus={countMinus}
                  />
                ))}
              </div>
              <div className="cart__bottom">
                ...
                <div className="cart__bottom-buttons">
                  ...
                  <Button onClick={handlerPayOrder} className="button pay-btn">
